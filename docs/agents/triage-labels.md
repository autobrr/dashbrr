...
The skills use five canonical triage roles. This table maps each role to its label in this repo.
...
When a skill names a triage role, use the corresponding repository label.
