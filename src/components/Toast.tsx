...
const Toast: FC<Props> = ({ type, body, t }) => (
  <div
    className={classNames(
      ...
      "max-w-sm w-full bg-white dark:bg-gray-800 whitespace-pre-wrap shadow-2xl rounded-lg pointer-events-auto overflow-hidden"
    )}
  >
    <div className="p-4">
      <div className="flex items-start">
        ...
        <div className="ml-4 flex-shrink-0 flex">
          <button
            className="bg-white dark:bg-gray-700 rounded-md inline-flex text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-blue-500 transition-colors duration-200"
            onClick={() => {
              toast.dismiss(t?.id);
            }}
          >
